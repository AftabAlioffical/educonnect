                    ...
                    <div class="query-singel mt-30">
                        ...
                        <div class="query-tab mt-30">
                            <ul class="nav nav-justified" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a id="reviews-tab" data-toggle="tab" href="#" role="tab" aria-controls="reviews" aria-selected="false">Reviews</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="reviews-cont">
                                    ...
                                    $question_id = intval($_GET['id']); // Ensure it's an integer
